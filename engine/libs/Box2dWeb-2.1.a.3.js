...
var B2Vector = Array, Vector_a2j_Number = Box2D.NVector;
...
(function () {
    ...
    z.prototype.Set = function (b) {
        switch (b.GetType()) {
            case K.e_circleShape:
                ...
                this.m_vertices = new B2Vector(1, true);
    ...
    D.b2DynamicTreeBroadPhase = function () {
        this.m_tree = new u;
        this.m_moveBuffer = new B2Vector;
        this.m_pairBuffer = new B2Vector;
        this.m_pairCount = 0
    };
    ...
    E.prototype.b2Manifold = function () {
        this.m_points = new B2Vector(y.b2_maxManifoldPoints);
    ...
    h.b2Simplex = function () {
        ...
        this.m_v2 = new j;
        this.m_v3 = new j;
        this.m_vertices = new B2Vector(3)
    };
...
(function () {
    ...
    A.prototype.b2PolygonShape = function () {
        ...
        this.m_vertices = new B2Vector;
        this.m_normals = new B2Vector
    };
...
(function () {
    ...
    Z.prototype.b2Island = function () {
        this.m_bodies = new B2Vector;
        this.m_contacts = new B2Vector;
        this.m_joints = new B2Vector
    };
    ...
    h.prototype.DrawShape = function (a, c, g) {
        switch (a.m_type) {
            ...
            case Y.e_polygonShape:
                ...
                var e = b.GetVertices(), f = new B2Vector(a);
    ...
    Box2D.postDefs.push(function () {
        ...
        Box2D.Dynamics.b2World.s_queue = new B2Vector;
...
(function () {
    ...
    U.prototype.b2ContactConstraint = function () {
        this.points = new B2Vector(O.b2_maxManifoldPoints);
    ...
    Q.prototype.InitializeRegisters =
        function () {
            this.m_registers = new B2Vector(y.e_shapeTypeCount);
            for (var j = 0; j < y.e_shapeTypeCount; j++) {
                this.m_registers[j] = new B2Vector(y.e_shapeTypeCount);
    ...
    L.b2ContactSolver = function () {
        this.m_step = new H;
        this.m_constraints = new B2Vector
    };
    ...
    u.prototype.b2PositionSolverManifold = function () {
        ...
        this.m_points = new B2Vector(O.b2_maxManifoldPoints);
